...
// immutable snapshot of the battle , passed to the UI so it can't accidentally touch live objects
public class GameState {
    ...
    public List<CombatantSnapshot> getCombatants() { return new ArrayList<>(combatants); }
    public int getCurrentRound()                    { return currentRound; }
    public BattleResult getResult()                 { return result; }

    // frozen copy of a combatant's stats at one point in time
    public static class CombatantSnapshot {
        ...
        public List<String> getActiveEffects() { return new ArrayList<>(activeEffects); }
    }
